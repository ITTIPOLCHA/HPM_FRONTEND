          ...
          {({ isValid, dirty }) => (
            <Form className={styles.formContainer}>
              ...
              <Space direction="vertical" size={24}>
                ...
                <Col span={24}>
                  <Typography.Title level={5}>
                    {t("sign_up.input.phoneNo")} <span className={styles.request}>*</span>
                  </Typography.Title>
                  <Input
                    name="phone"
                    size="large"
                ...
                <Col span={24}>
                  <Typography.Title level={5}>
                    {t("sign_in.placeholders.newPassword")} <span className={styles.request}>*</span>
                  </Typography.Title>
                  <Password
                    name="newPassword"
                    type="password"
                ...
                <Col span={24}>
                  <Typography.Title level={5}>
                    {t("sign_in.placeholders.confirm_password")} <span className={styles.request}>*</span>
                  </Typography.Title>
                  <Password
                ...
                <Col span={24}>
                  ...
                  >
                    <p className={styles.textbuttonConfirm}>{t("common.confirm")}</p>
                  </Button>
                </Col>
                <Col span={24}>
                  <Button
                    ...
                    htmlType="button"
                  >
                    <p className={styles.textbuttonCancel}>{t("common.cancel")}</p>
                  </Button>
                </Col>
              </Space>
            </Form>
